...
(function (global) {
  ...
  var STEPS = [
    ...
    },
    {
      ...
      mode: 'world',
      icon: '🟫',
      title: 'Add a platform to jump to',
      instruction: 'Paint a couple of brick blocks up in the air for your hero to jump onto.',
      why: 'Platforms turn a flat floor into a real jumping puzzle.',
      finishedEnough: 'Two brick blocks floating above the floor is plenty.',
      hint: 'Pick the brick tile (it acts as a platform), then click a few squares above the ground.',
      check: { type: 'behaviourTypePainted', params: { name: 'platform', min: 2 } },
    },
    {
      id: 'place-enemy',
      chapter: 'Chapter 3 — Build the world',
      ...
      why: 'A game needs a bit of danger to feel exciting.',
      finishedEnough: 'Dropping one enemy is enough. Put it away from the start.',
      hint: 'In World, pick the 🧍 Place tool, then click an empty spot on the screen to drop a character.',
    ...
    },
    {
      ...
      mode: 'rules',
      icon: '💬',
      title: 'Change what the villager says',
