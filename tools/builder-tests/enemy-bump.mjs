#!/usr/bin/env node
// Engine v81 — enemy-vs-enemy separation, the last open slice of feedback #30.
// Ported from `main`'s v77; 77-80 are different engines on this branch, so the
// gate and the degrade case below move with it.
...
globalThis.NES_TARGET_ENGINE = 81;

import * as H from './lib/render-harness.mjs';
import { testPort } from './lib/test-port.mjs';

const PORT = testPort(18853);
let failed = false;
...
console.log('\nEnemy-vs-enemy separation (engine v81, #30) test complete.');
