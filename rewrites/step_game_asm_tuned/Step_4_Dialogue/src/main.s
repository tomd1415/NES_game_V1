; =============================================================================
; Step 4 - Dialogue, hand-tuned ASM
; =============================================================================
; Builds on tuned Step 3: adds one NPC, A-button edge detection, a PLAYING /
; DIALOGUE state, and direct nametable writes for a one-line message.
...
npc_x:           .byte NPC_START_X
npc_y:           .byte NPC_START_Y
...
msg_hello:
        .byte $17,$14,$1B,$1B,$1E,$34,$17,$14,$21,$1E,$35,$00
...
.proc clear_dialog_row
        PPU_SEEK DIALOG_ADDR_HI, DIALOG_ADDR_LO
        ldx #DIALOG_WIDTH
        lda #$00
@loop:  sta PPUDATA
        dex
...
.proc draw_dialog_text
        PPU_SEEK DIALOG_ADDR_HI, DIALOG_ADDR_LO
        ldx #$00
@loop:  lda msg_hello,x
        beq @done
        sta PPUDATA
        inx
        bne @loop
...
.proc show_dialogue
        ...
        lda #$00
        sta PPUMASK
        jsr clear_dialog_row
        jsr draw_dialog_text
        jsr reset_scroll
        lda #$1E
        sta PPUMASK
        rts
